...
import id.co.devoxlabs.ezschool.wheel.ArrayWheelAdapter;
import id.co.devoxlabs.ezschool.wheel.NumericWheelAdapter;
import id.co.devoxlabs.ezschool.wheel.OnWheelChangedListener;
import id.co.devoxlabs.ezschool.wheel.WheelView;

import java.util.Calendar;

/**
 * Created by ignat on 21-Nov-16.
 */
public class myDatePickerDialog extends Dialog
{
  ...
  public myDatePickerDialog(Context context, Calendar calendar, final DatePickerListner dtp) {
    ...
    btnset.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        dtp.OnDoneButton(myDatePickerDialog.this, c);
      }
    });
    btncancel.setOnClickListener(new View.OnClickListener() {
      ...
      @Override
      public void onClick(View v) {
        dtp.OnCancelButton(myDatePickerDialog.this);
      }
    });
